                ...
                <div style="min-height: 120px;">
                    <div class="collapse collapse-horizontal" id="collapseWidthExample">
                        <div class="card card-body" style="width: 300px;">
                            Уважаемый покупатель! Товар можно купить в магазинах нашей сети или заказать на сайте.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-4 mt-4 mb-4">
                ...
                <div style="min-height: 120px;">
                    <div class="collapse collapse-horizontal" id="collapseWidthExample1">
                        <div class="card card-body" style="width: 300px;">
                            Уважаемый покупатель! Доставить товар можно любой транспортной компанией за ваш счет.
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-4 mt-4 mb-4">
                ...
                <div style="min-height: 120px;">
                    <div class="collapse collapse-horizontal" id="collapseWidthExample2">
                        <div class="card card-body" style="width: 300px;">
                            Уважаемый покупатель! Гарантии нет совсем!
                        </div>
                    </div>
                </div>
            </div>
